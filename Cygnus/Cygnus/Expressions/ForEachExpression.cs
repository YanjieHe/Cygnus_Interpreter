...
namespace Cygnus.Expressions
{
    public class ForEachExpression : Expression
    {
        ...
        public ForEachExpression(ParameterExpression Iterator, IEnumerable<CygnusObject> Collection, Expression Body)
        {
            this.Collection = new CygnusIEnumerable(Collection);
            this.Body = Body;
